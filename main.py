...
@bot.message_handler(commands=['ban'])  # Added
def command_ban(message): _logic_ban_user(message)
@bot.message_handler(commands=['unban'])  # Added
def command_unban(message): _logic_unban_user(message)
